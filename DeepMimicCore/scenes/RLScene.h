...
public:
	...
	virtual void SetTimeSeeds(int agent_id, const Eigen::VectorXd& time_seeds) = 0; //added 
	virtual void GetAllStates(int agent_id, Eigen::VectorXd& out_all_states) const = 0; //added
